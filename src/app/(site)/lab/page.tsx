...
const entries: LabEntry[] = [
  { scene: "circuit", title: "Hero", sentence: "Current runs along circuit traces and charges one ring.", ratio: "3/2" },
  ...
  { scene: "matching", title: "Apply", sentence: "Pulses run out to every lender; a few return and stay lit.", ratio: "3/2" },
];
